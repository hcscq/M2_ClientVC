...
// 입자관련 정보.
	...
	D3DXVECTOR3				m_vecOldPos;				// 좌표 보관.
	D3DXVECTOR3				m_vecVel;					// 속도.
	D3DXVECTOR3				m_vecAccel;					// 가속도.
	D3DXVECTOR3				m_vecLocalForce;			// 파티클에 개별 영향을 주는 힘.
	FLOAT					m_fMass;					// 질량.
	FLOAT					m_fSize;					// 크기.
...
//	D3DXVECTOR3				m_vecEnvironment;		// 입자에 작용하는 환경변수(중력, 바람).
	D3DXVECTOR3				m_vecBounding[2];		// 충돌체크영역 설정.
