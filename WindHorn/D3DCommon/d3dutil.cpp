...
// Desc: Helper function called to build a D3DMATERIAL9 structure
//-----------------------------------------------------------------------------
...
/******************************************************************************************************************
	...
	목적   : 렌더링스테이트를 셋팅한다.
	입력   : LPDIRECT3DDEVICE9 pd3dDevice
	         BYTE bBlendFlag
	         D3DMATERIAL9 mtrlGetMtrl
	출력   : void 
...
void SetBlendRenderState(LPDIRECT3DDEVICE9 pd3dDevice, BYTE bBlendFlag, D3DMATERIAL9 mtrlGetMtrl)
{
	...
	pd3dDevice->SetRenderState(D3DRS_COLORKEYENABLE, TRUE);
...
void ResetBlendenderState(LPDIRECT3DDEVICE9 pd3dDevice)
{
	...
	pd3dDevice->SetRenderState(D3DRS_COLORKEYENABLE, FALSE);
	pd3dDevice->SetRenderState(D3DRS_SRCBLEND , D3DBLEND_ONE);
	pd3dDevice->SetRenderState(D3DRS_DESTBLEND, D3DBLEND_ZERO);
}